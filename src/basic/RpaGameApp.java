...
public class RpaGameApp {
	public static void main(String[] args) {
		...
		while(true) {
			...
			//입력값이 1~3 범위의 정수값이 아닌 경우 메시지 출력 후 재입력
			int user;
		...
		System.out.println();
		if(count == 0) {
			System.out.println("[메시지]사용자가 컴퓨터에게 한번도 이기지 못했습니다.");
		} else {
			System.out.println("[메시지]사용자가 컴퓨터에게 " + count + "번 연속적으로 이겼습니다.");
		}
