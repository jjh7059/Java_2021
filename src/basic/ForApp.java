...
public class ForApp {
	public static void main(String[] args) {
		...
		//"Java Programming"를 화면에 출력
		for(int i = 0; i < 5; i++) {  //i 변수는 for 구문이 종료되면 소멸
			System.out.println("Java Programming");
		}
		System.out.println("========================================");
		...
		*/
		...
		//두 변수에 저장된 정수 값 범위의 정수들의 합계를 계산하여 출력하세요.
		int begin = 80, end = 30;
		
		//시작값이 종료값보다 큰 경우 두 변수 치환
		if(begin > end) {
			//치환 알고리즘(Swap Algorithm)
			//알고리즘(Algorithm) : 어떠한 문제를 해결하기 위한 명령 작성 방법
			int temp = begin;
			begin = end;
			end = temp;
		}
