...
public class ArrayApp {
	public static void main(String[] args) {
		...
		//자료형[] 참조변수 : 배열 정보를 저장하기 위한 참조변수의 자료형
		//new 자료형[요소갯수] : 자료형의 값을 갯수만큼 저장 가능한 배열 생성
		//배열은 요소(Element)를 이용하여 값을 여러 개 저장 - 요소는 첨자(Index)가 자동 부여
		...
		//System.out.println("num[3] = " + num[3]); 에러
		
		//배열참조변수 .length : 참조변수에 저장된 배열의 요소
		System.out.println("========================================");
		...
		//for 구문을 이용하여 배열의 요소에 대한 일관 처리 : 첨자 이용(입력, 연산, 출력 가능)
		...
		//내부 반복지시자를 이용하여 요소값을 제공받아 변수에 저장하여 처리 
		// - 입력X, 연산, 출력O
		...
		//배열의 요소값 중 30~60 범위의 요소값 갯수를 계산하여 출력하세요.
		int count = 0;
